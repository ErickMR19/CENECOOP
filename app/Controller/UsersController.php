...
function forgetpw(){
	...
	public function resumen(){
			...
			$this->set('fechaNacimientoUsuario', $perfil['fecha_nacimiento']);
			$this->set('nacionalidadUsuario', $perfil['nacionalidad']);
	...
	public function logout() {
		$this->Auth->logout();
	    $this->Session->setFlash(__('HA SALIDO SATISFACTORIAMENTE'));
